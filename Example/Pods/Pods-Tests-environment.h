...
// AXIRCSession
#define COCOAPODS_POD_AVAILABLE_AXIRCSession
#define COCOAPODS_VERSION_MAJOR_AXIRCSession 0
#define COCOAPODS_VERSION_MINOR_AXIRCSession 1
#define COCOAPODS_VERSION_PATCH_AXIRCSession 0
